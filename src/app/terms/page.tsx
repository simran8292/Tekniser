  ...
  return (
    <div className="pt-32 pb-20 min-h-screen bg-[#090d16]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <p className="text-slate-400 text-sm">Effective Date: {new Date().getFullYear()}</p>
        <div className="space-y-6 text-slate-300 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-white mb-2">2. Use of Platform</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-white mb-2">5. Governing Law</h2>
