        ...
        sections: [
            {
                ...
                children: [
                    ...
                    new docx_1.Paragraph({ text: "", pageBreakBefore: true }),
                    // ==================== HOME PAGE ====================
                    ...
                    createParagraph(`Quote: “${data_1.CORPORATE_INFO.vision2046}”`, { italic: true }),
                    ...
                    ...data_1.CAPABILITIES.map((cap, idx) => createBulletPoint(`${String(idx + 1).padStart(2, "0")}. ${cap.title}: `, cap.description)),
                    ...
                    ...data_1.INDUSTRIES.map((ind, idx) => createBulletPoint(`${String(idx + 1).padStart(2, "0")}. ${ind.title}: `, ind.description)),
                    ...
                    ...data_1.BUSINESS_DIVISIONS.flatMap((div) => [
                        new docx_1.Paragraph({
                            children: [
                                new docx_1.TextRun({
                    ...
                    ...data_1.GLOBAL_NETWORK_LOCATIONS.map((loc) => createBulletPoint(`• ${loc.title} (${loc.country}, Region: ${loc.region}): `, `${loc.description} [Type: ${loc.type.replace("_", " ")}]`)),
                    ...
                    createParagraph(`“${data_1.CORPORATE_INFO.vision2046}”`, { italic: true }),
                    createSubSectionHeading("Our Mission Pillars (Seven Pillars)"),
                    ...data_1.CORPORATE_INFO.missionPillars.map((pillar, idx) => createBulletPoint(`${String(idx + 1).padStart(2, "0")}. `, pillar)),
