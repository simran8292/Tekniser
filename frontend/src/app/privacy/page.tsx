  ...
  return (
    <div className="pt-32 pb-20 min-h-screen bg-[#f4f5f6] text-slate-800">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <h1 className="text-4xl font-black text-[#002d3b] uppercase">Privacy Policy</h1>
        <p className="text-slate-500 text-sm font-semibold">Last updated: {new Date().getFullYear()}</p>
        <div className="space-y-6 text-slate-650 text-sm leading-relaxed font-medium">
          <section>
            <h2 className="text-lg font-bold text-[#002d3b] mb-2">1. Data Controller</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#002d3b] mb-2">2. Data We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#002d3b] mb-2">3. Purpose of Processing</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#002d3b] mb-2">4. Data Retention</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#002d3b] mb-2">5. Your Rights</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#002d3b] mb-2">6. Contact</h2>
            <p>For any data protection enquiries, please contact TAKNISER GmbH through our corporate contact portal at <a href="/contact" className="text-[#009999] hover:underline font-bold">takniser.com/contact</a>.</p>
          </section>
        </div>
      </div>
    </div>
