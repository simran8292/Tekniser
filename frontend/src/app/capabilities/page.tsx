      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="space-y-6">
            <div className="border-b-2 border-[#009999] pb-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {PLATFORMS.map((plat) => {
                ...
                const isFullWidth = plat.code === "07";
                return (
                  <div
                    key={plat.code}
                    className={`bg-white border border-slate-200 p-6 sm:p-8 space-y-5 hover:border-[#009999] hover:shadow-lg transition-all flex flex-col justify-between ${
                      isFullWidth ? "md:col-span-2 bg-gradient-to-r from-white via-white to-slate-50 border-slate-300" : ""
                    }`}
                  >
                    <div className="space-y-4">
                      {/* Top Bar: Code + Icon + Title + Tagline */}
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <h4 className="text-lg sm:text-xl font-black text-[#002d3b] uppercase tracking-tight">
                              {plat.title}
                            </h4>
                          </div>
                        </div>
                        <span className="inline-block px-3 py-1 bg-slate-100 border border-slate-200 text-xs font-bold text-[#009999] uppercase tracking-wider w-fit">
                          {plat.tagline}
                        </span>
                      </div>
                    ...
                    {/* Footer mandate */}
                    <div className="pt-4 border-t border-slate-100 flex items-center gap-2 text-xs sm:text-sm font-bold text-[#009999]">
